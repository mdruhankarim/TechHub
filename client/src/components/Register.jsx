      ...
      <Card className="overflow-hidden p-0 shadow-xl border border-gray-200">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 border-gray-300 focus:border-black"
                  {...register("password", {
          ...
          <div className="relative hidden md:flex flex-col bg-gray-100">
            ...
            <div className="absolute bottom-8 left-8 right-8 flex items-start gap-3">
              <Shield className="w-5 h-5 mt-0.5 text-gray-700 shrink-0" />
              <div>
                <p className="font-semibold text-sm text-gray-900">
                  Join with Confidence
                </p>
                <p className="text-xs text-gray-600 mt-0.5 leading-relaxed">
                  We protect your information and never share your data.
                </p>
              </div>
            </div>
          </div>
